...
<body>
    ...
    <div class="sidebar mt-5" id="sidebar">
        <a href="{{ route('admin.dashboard') }}"><i class="fas fa-home icon"></i> Home</a>
        <a href="{{ route('admin_ruangan.requests') }}"><i class="fas fa-bell icon"></i> Requests</a>
        <a class="nav-link" href="{{ route('admin_ruangan.history') }}"><i class="fas fa-history"></i> History</a>
        <a class="nav-link" href="{{ route('admin_ruangan.create_room') }}"> <i class="fas fa-plus-circle"></i> Add Room</a>
    </div>
