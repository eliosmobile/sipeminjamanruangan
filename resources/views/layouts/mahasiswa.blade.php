...
<body>
    ...
    <div class="sidebar mt-5" id="sidebar">
        <a href="{{ route('mahasiswa.dashboard') }}"><i class="fas fa-home icon"></i> Home</a>
        <a href="{{ route('mahasiswa.storeRequest') }}"><i class="fas fa-edit icon"></i> Request</a>
        <a href="{{ route('mahasiswa.history') }}"><i class="fas fa-history icon"></i> History</a>
    </div>
